<div>
    ...
    @endif
    <div class="pt-4">
        <button wire:click="confirmPostAdd"
    ...
    <x-jet-dialog-modal wire:model="confirmingPostAdd">
        <x-slot name="title">
            {{ __('Add Post') }}
        </x-slot>
        ...
        <x-slot name="footer">
            <x-jet-secondary-button wire:click="$set('confirmingPostAdd',false)" wire:loading.attr="disabled">
                {{ __('Nevermind') }}
