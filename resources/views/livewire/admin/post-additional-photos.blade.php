<div>
    ...
    <div class="flex flex-wrap">
        ...
        @foreach ($photos as $photo)
           <img class="w-1/2 py-4 px-4" src="{{ url('storage/additional_photos/'.$photo->filename) }}" alt="">
           <button wire:click="confirmPhotoDeletion({{ $photo->id }})" wire:loading.attr="disabled"
